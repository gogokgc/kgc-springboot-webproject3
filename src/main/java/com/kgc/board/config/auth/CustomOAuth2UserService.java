...
import com.kgc.board.config.auth.dto.OAuthAttributes;
import com.kgc.board.config.auth.dto.SessionUser;
import com.kgc.board.domain.user.User;
import com.kgc.board.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        String userNameAttributeName = userRequest.getClientRegistration().getProviderDetails() // OAuth2 로그인 진행 시 키가 되는 필드값을 이야기합니다. Primary Key와 같은의미
